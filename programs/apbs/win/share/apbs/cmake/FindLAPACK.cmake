...
function(CHECK_LAPACK_LIBRARIES LIBRARIES _prefix _name _flags _list _deps _addlibdir _subdirs _blas)
  ...
  message(STATUS "%%%%% list of libraries: ${_list}")
  foreach(_library ${_list})
    ...
    if(_library MATCHES "^-")
      ...
      if(_libraries_work)
        message(STATUS "%%%% Checking for library ${_library}")
        message(STATUS "     PATHS: ${_extaddlibdir}")
        message(STATUS "     PATH_SUFFIXES: ${_subdirs}")
  ...
  endforeach()
  message(STATUS "Testing libraries: ${_libraries_work}")
  if(_libraries_work)
    ...
    if(CMAKE_Fortran_COMPILER_LOADED)
      message(STATUS "checking for fortran function ${_name}")
      check_fortran_function_exists("${_name}" ${_prefix}${_combined_name}_WORKS)
    else()
      message(STATUS "checking for function ${_name}_")
      #check_function_exists("${_name}_" ${_prefix}${_combined_name}_WORKS)
      set( ${_prefix}${_combined_name}_WORKS TRUE)
      endif()
    set(CMAKE_REQUIRED_LIBRARIES)
    set(_libraries_work ${${_prefix}${_combined_name}_WORKS})
    message(STATUS "    result: ${_libraries_work}")
  endif()
...
if(NOT LAPACK_NOT_FOUND_MESSAGE)
  ...
  if(NOT LAPACK_LIBRARIES
    ...
    message(STATUS "%%%%%%% Custom FindLAPACK.cmake %%%%%%%%%")

    set(_lapack_openblas_lib "openblas")
    set(_lapack_lib "lapack")
    if(_lapack_sizeof_integer EQUAL 8)
      string(APPEND _lapack_openblas_lib "64")
      string(APPEND _lapack_lib "64")
    endif()

    set(_lapack_all_libs ${_lapack_openblas_lib} ${_lapack_lib})
    message(STATUS "%%%% all libs: ${_lapack_all_libs}")
